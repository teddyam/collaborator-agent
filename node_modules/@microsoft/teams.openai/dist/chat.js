...
class OpenAIChatModel {
  constructor(options) {
    ...
    this._openai = "endpoint" in options ? new OpenAI.AzureOpenAI({
  ...
  async send(input, options = {}) {
    const memory = options.messages || new teams_ai.LocalMemory();
    ...
    try {
      ...
      if (!(completion instanceof streaming.Stream)) {
